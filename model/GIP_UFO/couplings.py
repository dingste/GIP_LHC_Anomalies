...
GC_10 = Coupling(name = 'GC_10',
                 value = '-G * cmath.exp(-Q2 / OmegaGIP**2)',
                 order = {'QCD':1})

GC_11 = Coupling(name = 'GC_11',
                 value = 'complex(0,1)*G * cmath.exp(-Q2 / OmegaGIP**2)',
                 order = {'QCD':1})
...
GC_GIP_Asymmetry = Coupling(name = 'GC_GIP_Asymmetry',
                            value = 'G * (1.0 if P(0,3)**2 >= 490000.0 else 0.0)',
                            order = {'QED':1})
